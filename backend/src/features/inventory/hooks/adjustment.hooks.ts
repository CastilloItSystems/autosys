 ...
 */
export const afterAdjustmentApply = async (context: IHookContext): Promise<void> => {
  try {
    const {
      adjustmentId,
      items,
 ...
 */
export const afterAdjustmentReject = async (context: IHookContext): Promise<void> => {
  try {
 ...
 */
export const beforeAdjustmentApprove = async (context: IHookContext): Promise<void> => {
  try {
