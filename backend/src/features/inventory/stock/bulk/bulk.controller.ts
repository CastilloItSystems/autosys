...
export class StockBulkController {
  ...
  import = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await stockBulkService.importStock(
      fileContent,
      fileName,
      userId,
      empresaId,
  ...
  adjust = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await stockBulkService.adjustStock(
      fileContent,
      fileName,
      userId,
      empresaId
  ...
  transfer = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      const result = await stockBulkService.transferStock(
        fileContent,
        fileName,
        userId,
        empresaId
  ...
  export = asyncHandler(async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await stockBulkService.exportStock(
      req.body,
      userId,
      empresaId
    )
  ...
  getOperations = asyncHandler(
    async (req: Request, res: Response): Promise<void> => {
      ...
      const result = await stockBulkService.getOperations(
        Number(page),
        Number(limit),
        empresaId
      )
