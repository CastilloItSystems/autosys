...
export const getAll = async (req: Request, res: Response) => {
  const result = await deliveriesService.findAllDeliveries(prisma, req.empresaId!, req.validatedQuery as any)
...
export const create = async (req: Request, res: Response) => {
  ...
  return ApiResponse.created(res, new DeliveryResponseDTO(item), WORKSHOP_MESSAGES.delivery.created)
}
