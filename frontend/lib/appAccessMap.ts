...
export const APP_ACCESS_RULES: RoutePermissionRule[] = [
  ...
  { prefix: "/profile/list", actions: crud("platform_users", "any") },
  {
    ...
    actions: {
      view: gate("platform_users.create", "any"),
      create: gate("platform_users.create", "any"),
    },
  },
  ...
  {
    prefix: "/empresa/ventas/reportes",
    actions: { view: gate("reports.view"), export: gate("reports.export") },
  },
  {
    prefix: "/empresa/ventas",
    actions: {
      view: anyGate([
        "customers.view",
        "orders.view",
  ...
  {
    prefix: "/empresa/compras/reportes/rendimiento-proveedores",
    actions: { view: gate("reports.view"), export: gate("reports.export") },
  },
  {
    prefix: "/empresa/compras",
    actions: {
      view: anyGate([
  ...
  {
    prefix: "/empresa/inventario/reportes",
    actions: { view: gate("reports.view"), export: gate("reports.export") },
  },
  ...
  {
    prefix: "/empresa/inventario/stock",
    actions: {
      view: gate("stock.view"),
      create: gate("stock.adjust"),
      update: gate("stock.adjust"),
      approve: gate("stock.approve"),
    },
  },
  ...
  {
    prefix: "/empresa/inventario/ajustes",
    actions: {
      view: gate("inventory.view"),
      create: gate("stock.adjust"),
      update: gate("stock.adjust"),
      approve: gate("stock.approve"),
    },
  ...
  {
    prefix: "/empresa/concesionario/approvals",
    actions: {
      view: gate("dealer.approve"),
      update: gate("dealer.approve"),
      approve: gate("dealer.approve"),
    },
  },
  {
    prefix: "/empresa/concesionario/automations",
    actions: {
      view: gate("crm.automations.view"),
      update: gate("crm.automations.run"),
    },
  },
  {
    prefix: "/empresa/concesionario/integrations",
    actions: { view: gate("dealer.view"), update: gate("dealer.update") },
  },
  {
    prefix: "/empresa/concesionario/reports",
    actions: { view: gate("reports.view"), export: gate("reports.export") },
  },
  { prefix: "/empresa/concesionario", actions: crud("dealer") },

  {
    prefix: "/empresa/finanzas/cuentas-bancarias",
    actions: manage("finance.bank_accounts.view", "finance.bank_accounts.manage"),
  },
  {
    prefix: "/empresa/finanzas/facturas-proveedor",
    actions: manage("finance.supplier_bills.view", "finance.supplier_bills.manage"),
  },
  {
    prefix: "/empresa/finanzas/pagos-proveedor",
    actions: {
      view: gate("finance.supplier_payments.view"),
      create: gate("finance.supplier_payments.create"),
      update: gate("finance.supplier_payments.cancel"),
      delete: gate("finance.supplier_payments.cancel"),
    },
  },
  {
    prefix: "/empresa/finanzas/gastos-recurrentes",
    actions: manage("finance.view", "finance.recurring_rules.manage"),
  },
  {
    prefix: "/empresa/finanzas/gastos",
    actions: manage("finance.expenses.view", "finance.expenses.manage"),
  },
  {
    prefix: "/empresa/finanzas/flujo-caja",
    actions: { view: gate("finance.cash_flow.view") },
  },
  { prefix: "/empresa/finanzas/tipos-cambio", actions: crud("exchange_rates") },
  { prefix: "/empresa/finanzas", actions: { view: gate("finance.view") } },

  {
    prefix: "/empresa/finance",
    actions: { view: gate("finance.view") },
    legacy: true,
  },
  {
    prefix: "/empresa",
...
export function getPermissionGateForPath(
  ...
  const path = normalizeAccessPath(pathname);
  const rule = APP_ACCESS_RULES.find(
