...
import type {
  ...
  TOTStatus,
  TOTDocumentType,
} from "@/modules/workshop/tot/interfaces/tot.interface";
import TOTStatusBadge, { TOT_STATUS_LABELS } from "./TOTStatusBadge";
import { useTOTData } from "../hooks/useTOTData";
...
export default function TOTList({ serviceOrderId, embedded }: Props) {
  ...
  const { tots: items, total: totalRecords, loading, mutate } = useTOTData(
