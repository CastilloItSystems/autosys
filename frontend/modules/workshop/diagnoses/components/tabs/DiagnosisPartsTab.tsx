...
import type { DiagnosisSuggestedPart } from "@/modules/workshop/diagnoses/interfaces/diagnosis.interface";
...
export default function DiagnosisPartsTab({
  diagnosisId,
  parts,
  onRefresh,
  toast,
    ...
    <div className="pt-2">
      <div className="flex justify-content-between align-items-center mb-3">
        <span className="text-sm text-500">
          {parts.length === 0
            ? "No hay repuestos sugeridos."
            : `${parts.length} repuesto${
                parts.length !== 1 ? "s" : ""
              } sugerido${parts.length !== 1 ? "s" : ""}.`}
        </span>
        <Button
          ...
          <div className="grid formgrid">
            <div className="col-12 md:col-4">
              ...
              <InputNumber
                value={form.quantity}
                onValueChange={(e) =>
                  setForm((f) => ({ ...f, quantity: e.value ?? 1 }))
                }
                min={0.01}
                minFractionDigits={0}
                maxFractionDigits={2}
            ...
            <div className="col-12 md:col-4">
              ...
              <InputNumber
                ...
                onValueChange={(e) =>
                  setForm((f) => ({ ...f, estimatedCost: e.value ?? 0 }))
                }
                min={0}
                mode="currency"
                currency="USD"
