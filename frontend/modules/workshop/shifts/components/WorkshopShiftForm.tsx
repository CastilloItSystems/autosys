...
} from "@/modules/workshop/shifts/schemas/workshopShiftZod";
...
export default function WorkshopShiftForm({
  ...
  const {
    ...
    resolver: zodResolver(
      shift ? updateWorkshopShiftSchema : createWorkshopShiftSchema,
    ),
    mode: "onBlur",
    defaultValues: {
      code: "",
    ...
    >
      <div className="grid">
        ...
        <div className="col-12">
          ...
          {errors.workDays && (
            <small className="p-error block mt-1">
              {(errors.workDays as any).message}
            </small>
          )}
        </div>
      </div>
