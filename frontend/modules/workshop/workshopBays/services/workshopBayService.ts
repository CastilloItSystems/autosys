...
} from "../interfaces/workshopBay.interface";
import type {
...
const workshopBayService = {
  async getAll(
    filters?: WorkshopBayFilters,
  ): Promise<WorkshopPagedResponse<WorkshopBay>> {
  ...
  async create(
    data: CreateWorkshopBayInput,
  ): Promise<WorkshopResponse<WorkshopBay>> {
