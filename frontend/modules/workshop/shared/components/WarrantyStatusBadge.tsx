...
import type { WarrantyStatus } from "@/modules/workshop/warranties/interfaces/warranty.interface";
import type { WarrantyType } from "@/modules/workshop/warranties/interfaces/warranty.interface";
...
export const WARRANTY_STATUS_OPTIONS = (
  Object.keys(WARRANTY_STATUS_LABELS) as WarrantyStatus[]
).map((v) => ({
...
export const WARRANTY_TYPE_OPTIONS = (
  Object.keys(WARRANTY_TYPE_LABELS) as WarrantyType[]
).map((v) => ({
