...
import vehicleHistoryService from "@/modules/workshop/vehicleHistory/services/vehicleHistoryService";
import type { VehicleHistoryData } from "@/modules/workshop/vehicleHistory/interfaces/vehicleHistory.interface";
  ...
  data.serviceOrders.forEach((so) =>
    entries.push({
      ...
      description: so.total
        ? `Total: ${so.total.toLocaleString("es-MX", {
            style: "currency",
            currency: "MXN",
          })}`
        : undefined,
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <div className="text-900 font-semibold">
                  {historyData.vehicle.mileage
                    ? `${historyData.vehicle.mileage.toLocaleString(
                        "es-MX",
                      )} km`
                    : "—"}
                </div>
