...
import type {
  ...
  WorkOrderFilters,
  WorkOrderResponse,
} from "@/modules/workshop/shared/interfaces/workOrderMain.interface";
import type { WorkOrderStatus } from "@/modules/workshop/shared/interfaces/workOrderStatus.interface";
import { WorkOrderHistory } from "@/modules/workshop/serviceOrders/interfaces/workOrderMain.interface";
type WorkOrderFormData = Partial<WorkOrder>;
type WorkOrderStatusFormData = Partial<WorkOrderStatus>;
