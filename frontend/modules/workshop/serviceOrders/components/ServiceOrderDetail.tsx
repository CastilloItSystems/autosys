...
import type { ServiceOrder } from '@/modules/workshop/serviceOrders/interfaces/serviceOrder.interface';;
...
import AttachmentPanel from "@/modules/workshop/shared/components/AttachmentPanel";
import AuditLogPanel from "@/modules/workshop/shared/components/AuditLogPanel";
...
const DiagnosisList = React.lazy(
  () => import("@/modules/workshop/diagnoses/components/DiagnosisList")
);
const MaterialList = React.lazy(
  () => import("@/modules/workshop/materials/components/MaterialList")
);
const AdditionalList = React.lazy(
  () => import("@/modules/workshop/additionals/components/AdditionalList")
);
const LaborTimeList = React.lazy(
  () => import("@/modules/workshop/laborTimes/components/LaborTimeList")
);
const QualityCheckList = React.lazy(
  () => import("@/modules/workshop/qualityChecks/components/QualityCheckList")
);
const TOTList = React.lazy(
  () => import("@/modules/workshop/tot/components/TOTList")
);
const GaritaList = React.lazy(
  () => import("@/modules/workshop/garita/components/GaritaList")
);
