...
import billingBridgeService from '@/modules/workshop/billingBridge/services/billingBridgeService';
import serviceOrderService from '@/modules/workshop/serviceOrders/services/serviceOrderService';
import type { ServiceOrder, ServiceOrderStatus } from '@/modules/workshop/serviceOrders/interfaces/serviceOrder.interface';
import {
  ServiceOrderStatusBadge,
  ServiceOrderPriorityBadge,
  SO_STATUS_OPTIONS,
} from "@/modules/workshop/shared/components/ServiceOrderStatusBadge";
...
export default function ServiceOrderList() {
  ...
  const currencyBodyTemplate = (row: ServiceOrder) => {
    ...
    return (
      <Tag
        value={cur}
        severity={cur === "VES" ? "warning" : cur === "EUR" ? "secondary" : "info"}
        className="text-xs"
      />
    );
  };
