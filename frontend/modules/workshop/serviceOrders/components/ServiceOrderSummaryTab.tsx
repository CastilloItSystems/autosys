...
import WorkshopFormSection from "@/modules/workshop/shared/components/WorkshopFormSection";
import { ServiceOrderStatusBadge } from "@/modules/workshop/shared/components/ServiceOrderStatusBadge";
import { WorkshopFinancialSummary } from "@/modules/workshop/shared/components";
      ...
      <div className="col-12 lg:col-8">
        <WorkshopFormSection title="Información General" icon="pi-info-circle">
          <div className="grid">
            ...
            <div className="col-12 md:col-6">
              <Field label="Origen" value={serviceOrder.receptionId ? "Recepción" : serviceOrder.appointmentId ? "Cita" : "Manual"} />
            </div>
            <div className="col-12 md:col-6">
              <Field
