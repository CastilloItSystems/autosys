...
} from "@/modules/workshop/warranties/schemas/warrantyZod";
import type {
  CreateWarrantyForm,
  UpdateWarrantyForm,
} from "@/modules/workshop/warranties/schemas/warrantyZod";
import type { WorkshopWarranty } from "@/modules/workshop/warranties/interfaces/warranty.interface";
import { WARRANTY_TYPE_OPTIONS } from "@/modules/workshop/shared/components/WarrantyStatusBadge";
        ...
        <div className="grid">
          ...
          <div className="col-12">
            <div className="p-3 surface-100 border-round flex gap-4 text-sm mb-1">
              <span>
                <b>Folio:</b> {warranty.warrantyNumber}
              </span>
              <span>
                <b>Cliente:</b>{" "}
                {warranty.customer?.name ?? warranty.customerId.slice(0, 8)}
              </span>
              <span>
                <b>OT:</b>{" "}
                {warranty.originalOrder?.folio ??
                  warranty.originalOrderId.slice(0, 8)}
              </span>
            </div>
          </div>
