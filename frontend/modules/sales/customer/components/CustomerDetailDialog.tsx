...
export default function CustomerDetailDialog({
  ...
  const typeCfg =
    CUSTOMER_TYPE_CONFIG[customer.type as keyof typeof CUSTOMER_TYPE_CONFIG];
            ...
            <div className="surface-card border-round border-1 border-surface-border p-3 flex flex-column gap-2">
              ...
              {customer.email && (
                <a
                  ...
                  className="text-sm text-primary no-underline flex align-items-center gap-2"
                >
        ...
        <div className="col-12 md:col-9 p-4">
          ...
          <div className="grid">
            <Field
              ...
              value={`Lista ${customer.priceList}`}
              icon="pi pi-list"
            />
            <Field
            ...
            <div className="col-12 md:col-6 mb-3">
              <div className="surface-50 border-round p-3 h-full">
                ...
                <Tag
                  ...
                  severity={
                    customer.isSpecialTaxpayer ? "warning" : "secondary"
                  }
                  rounded
                />
              </div>
