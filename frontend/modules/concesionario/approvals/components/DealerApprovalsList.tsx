...
import dealerApprovalService, {
  DealerApproval,
} from "../services/dealerApprovalService";
import { handleFormError } from "@/utils/errorHandlers";
import {
  APPROVAL_TYPE_FILTER_OPTIONS,
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Dropdown
          value={typeFilter}
          options={APPROVAL_TYPE_FILTER_OPTIONS}
          onChange={(e) => {
  ...
  return (
    <div className="card">
      ...
      >
        ...
        <Column
          ...
          body={(rowData: DealerApproval) => {
            const meta = APPROVAL_STATUS_META[rowData.status] || {
      ...
      <DeleteConfirmDialog
        ...
        itemName={
          selected?.title || selected?.approvalNumber || "esta aprobación"
        }
