...
import dealerAfterSaleService, {
  DealerAfterSale,
} from "../services/dealerAfterSaleService";
import { handleFormError } from "@/utils/errorHandlers";
import {
  AFTER_SALE_TYPE_FILTER_OPTIONS,
  AFTER_SALE_STATUS_FILTER_OPTIONS,
  ...
  const header = (
    <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
      ...
      <div className="flex flex-wrap gap-2">
        <Dropdown
          value={statusFilter}
          options={AFTER_SALE_STATUS_FILTER_OPTIONS}
          onChange={(e) => {
        ...
        <Dropdown
          value={typeFilter}
          options={AFTER_SALE_TYPE_FILTER_OPTIONS}
          onChange={(e) => {
      ...
      >
        ...
        <Column
          ...
          body={(rowData: DealerAfterSale) => {
            const meta = AFTER_SALE_STATUS_META[rowData.status] || {
