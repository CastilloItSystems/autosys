...
import {
  LEAD_STATUS_CONFIG,
  LEAD_CHANNEL_CONFIG,
} from "@/modules/crm/leads/interfaces/lead.interface";
import { QUOTE_STATUS_CONFIG } from "@/modules/crm/quotes/interfaces/quote.interface";
import {
  CASE_STATUS_CONFIG,
  CASE_PRIORITY_CONFIG,
} from "@/modules/crm/cases/interfaces/case.interface";
import {
  formatDashboardCurrency as formatCurrency,
  isDashboardDateOverdue as isOverdue,
  formatDashboardDate as formatDate,
} from "../utils/crmDashboard.utils";
