...
import {
  CASE_TYPE_FILTER_OPTIONS as typeFilterOptions,
  CASE_STATUS_FILTER_OPTIONS as statusFilterOptions,
  CASE_PRIORITY_FILTER_OPTIONS as priorityFilterOptions,
  CASE_TERMINAL_STATUSES as TERMINAL_STATUSES,
...
export default function CaseList() {
  ...
  const slaBody = (c: Case) => {
    ...
    return (
      <span
        className={`text-sm ${isOverdue ? "text-red-500 font-semibold" : ""}`}
      >
  ...
  return (
    <>
      ...
      <ConfirmDialog />
      <Menu
        model={menuItems(actionCase as Case)}
        popup
        ref={menuRef}
        id="case-menu"
      />
