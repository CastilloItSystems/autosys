...
import {
  ...
  CUSTOMER_TYPE_LIST_FILTER_OPTIONS,
...
const CustomerCrmList = () => {
  ...
  /* ── Table header ── */
  const segmentOptions = CUSTOMER_SEGMENT_LIST_FILTER_OPTIONS;
  const channelOptions = CUSTOMER_CHANNEL_LIST_FILTER_OPTIONS;
  const typeOptions = CUSTOMER_TYPE_LIST_FILTER_OPTIONS;
