...
import { CustomerCrmFormProps } from "../interfaces/customerCrmForm.interface";
import {
  CUSTOMER_TYPE_OPTIONS as typeOptions,
  CUSTOMER_SEGMENT_OPTIONS as segmentOptions,
  CUSTOMER_CHANNEL_OPTIONS as channelOptions,
