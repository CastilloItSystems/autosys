...
export default function TransferForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      items: transfer?.items || [{ itemId: "", quantity: 1, unitCost: 0 }],
  ...
  const filteredToWarehouseOptions = filteredToWarehouses.map((w) => ({
    label: w.name,
    value: w.id,
  }));
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          <label className="font-semibold text-gray-700">Artículos *</label>
          <Button
            type="button"
      ...
      <div className="flex justify-end gap-3 pt-4">
        ...
        <Button
          type="submit"
          label={transfer ? "Actualizar" : "Crear"}
