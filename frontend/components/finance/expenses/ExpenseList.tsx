  ...
  const amountBody = (row: Expense) => (
    <div>
      <div className="font-semibold">
        {row.currency}{" "}
        {Number(row.total).toLocaleString("es-VE", {
      ...
      {Number(row.pendingAmount) > 0 && (
        <div className="text-sm text-orange-500">
          Pend:{" "}
          {Number(row.pendingAmount).toLocaleString("es-VE", {
            minimumFractionDigits: 2,
          })}
        </div>
      )}
      ...
      <div className="card">
        ...
        >
          ...
          <Column
            ...
            header="Fecha"
            body={(r: Expense) =>
              new Date(r.expenseDate).toLocaleDateString("es-VE")
            }
            sortable
          />
          ...
          <Column
            header="Recurrente"
            body={(r: Expense) =>
              r.isRecurring ? <i className="pi pi-sync text-primary" /> : null
            }
