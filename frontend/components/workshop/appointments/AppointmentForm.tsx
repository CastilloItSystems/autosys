...
import { appointmentService, serviceTypeService } from "@/app/api/workshop";
import {
  createAppointmentSchema,
  updateAppointmentSchema,
  type CreateAppointmentForm,
} from "@/libs/zods/workshop/appointmentZod";
import type { ServiceAppointment, ServiceType } from "@/libs/interfaces/workshop";
...
export default function AppointmentForm({
    ...
    if (appointment) {
      reset({
        ...
        scheduledDate: appointment.scheduledDate
          ? appointment.scheduledDate.substring(0, 16)
          : "",
  ...
  return (
    <form id={formId ?? "appointment-form"} onSubmit={handleSubmit(onSubmit)} className="p-fluid">
      <div className="grid">
        ...
        <div className="col-12 md:col-6">
          <label htmlFor="scheduledDate" className="block text-900 font-medium mb-2">
          ...
          />
          {errors.scheduledDate && <small className="p-error block mt-1">{errors.scheduledDate.message}</small>}
        </div>

        <div className="col-12 md:col-6">
          <label htmlFor="estimatedMinutes" className="block text-900 font-medium mb-2">
        ...
        <div className="col-12 md:col-6">
          <label htmlFor="clientNotes" className="block text-900 font-medium mb-2">
            Notas del cliente
          </label>
          <Controller
            name="clientNotes"
        ...
        <div className="col-12 md:col-6">
          <label htmlFor="internalNotes" className="block text-900 font-medium mb-2">
            Notas internas
          </label>
          <Controller
            name="internalNotes"
