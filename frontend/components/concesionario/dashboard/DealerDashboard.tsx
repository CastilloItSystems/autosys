    ...
    () => [
      {
        ...
        icon: "pi pi-car",
        color: "blue",
        subtitle: `Disp: ${overview?.units.available ?? 0} · Reserv: ${overview?.units.reserved ?? 0}`,
      },
      {
        label: "Reservas",
      ...
      <div className="grid">
          ...
          <div className="card mb-0">
            ...
            >
              ...
              <Column
                ...
                style={{ width: "90px" }}
                body={(row: DealerHistoryItem) => (
                  <span className="text-xs font-mono text-500">{row.number}</span>
                )}
              />
              ...
              <Column
                ...
                style={{ width: "90px" }}
                body={(row: DealerHistoryItem) => (
                  <span className="text-xs text-500">{formatDate(row.occurredAt)}</span>
                )}
              />
            </DataTable>
          </div>
        ...
        <div className="col-12 lg:col-4">
          <div className="card mb-0 h-full">
            ...
            >
              <div>
                <div className="text-500 text-xs mb-1">Leads CRM · Canal VEHICULOS</div>
            ...
            <div className="flex flex-column gap-2">
              {(integrations?.alerts || []).map((alert) => (
                ...
                >
                  ...
                  <Tag value={String(alert.count)} severity={alert.severity} rounded />
                </div>
              ))}
