...
export const TOT_DOCUMENT_TYPES = [
  "PROVIDER_QUOTE",
  "DELIVERY_ACT",
  "RETURN_ACT",
  "PROVIDER_INVOICE",
...
export const createTOTSchema = z.object({
  ...
  partDescription: z
    .string()
    .min(1, "La descripción de la pieza es requerida")
    .max(1000),
  partSerial: z.string().max(100).nullable().optional(),
  photoUrls: z.array(z.string().url()).default([]),
  requestedWork: z
    .string()
    .min(1, "El trabajo solicitado es requerido")
    .max(2000),
...
export const updateTOTSchema = createTOTSchema
  .partial()
