...
const receptionService = {
  async getAll(filters?: ReceptionFilters): Promise<WorkshopPagedResponse<VehicleReception>> {
  ...
  async create(data: CreateReceptionInput): Promise<WorkshopResponse<VehicleReception>> {
    const res = await apiClient.post(BASE, data)
    return res.data
  },

  async update(id: string, data: UpdateReceptionInput): Promise<WorkshopResponse<VehicleReception>> {
